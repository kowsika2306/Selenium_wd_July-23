...
//Moved to baseclass
	 ...
	 * 
	 * // Creating object for the class ReadExcel ->call the readExcel() ReadExcel
	 * re = new ReadExcel(); String[][] data = re.readExcel("DLead"); return data;
	 * 
	 * }
	 */

	/*
	 * @DataProvider public String[][] sendData() { //two dimentional data to pass
	 * into test steps String[][] data=new String[2][1]; data[0][0]="99";
	 * 
	 * data[1][0]="91";
	 * 
	 * return data;
